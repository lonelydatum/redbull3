...
var clip = "rect(0px 30px 1200px 30px)";
...
function frame1() {
	...
	tlF1.add((0, _commonJsCommonJs.maskBunch)(['.t1a', '.t1b', '.t1c', '.t1d', '.t1e'], clip));
...
function beamsPlay() {
	...
	tlF2.add((0, _commonJsCommonJs.cascade)(".beam_b", 5), .3);
	return tlF2;
}
...
function frame3() {
	...
	tlDots.add((0, _commonJsCommonJs.cascade)(".dot.red", 3), .25);
	tlFlashyStuff.add(tlDots);

	var tlRings = new TimelineMax();
	tlRings.add((0, _commonJsCommonJs.cascade)(".ring.red", 2));
	tlRings.add((0, _commonJsCommonJs.cascade)(".ring.blue", 2), .2);
